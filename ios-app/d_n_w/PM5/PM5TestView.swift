    ...
    private var connectionStatusSection: some View {
        VStack(spacing: 12) {
            ...
            HStack(spacing: 12) {
                ...
                Button(pm5Controller.isMockMode ? "Exit Mock" : "Mock Mode") {
                    if pm5Controller.isMockMode {
                        pm5Controller.disableMockMode()
                    } else {
                        pm5Controller.enableMockMode()
                    }
                }
                .buttonStyle(.borderedProminent)
                
                if pm5Controller.isConnected && !pm5Controller.isMockMode {
                    Button("Disconnect") {
