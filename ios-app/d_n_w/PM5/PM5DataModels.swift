...
extension PM5RowingData {
    ...
    var currentSpeed: Double? {
        additionalStatus1?.speed
    }
    
    var currentPace: TimeInterval? {
        additionalStatus1?.currentPace
    }
    
    var strokeRate: UInt8? {
        additionalStatus1?.strokeRate
    }
    ...
    var distance: Double? {
        generalStatus?.distance
    }
    
    var elapsedTime: TimeInterval? {
        generalStatus?.elapsedTime
    }
    
    var calories: UInt16? {
        additionalStatus2?.totalCalories
    }
    
    var averagePower: UInt16? {
        additionalStatus2?.averagePower
    }
}
